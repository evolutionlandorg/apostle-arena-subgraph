...
export class objectOwnership extends ethereum.SmartContract {
  static bind(address: Address): objectOwnership {
    return new objectOwnership("objectOwnership", address);
  }
